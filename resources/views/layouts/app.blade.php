...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/img/jobs.png">


</head>

<body class="bg-color-blue-light text-color-primary tracking-wider">

    <div id="app">
        <!-----header---->
        <header class="sticky top-0 left-0 bg-white z-10">
            <nav class="bg-white border-white py-2.5 dark:bg-color-gray-light">
                <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    <a href="#" class="flex items-center space-x-4 rtl:space-x-reverse">
                        <img src="/img/jobs.png" class="h-16 w-28" alt="Flowbite Logo" />
                    </a>
                    <div class="flex items-center lg:order-2">
                        <a href="https://play.google.com/store/apps/details?id=com.meritlife.tech.jobseva"
                            class="text-white bg-color-blue hover:bg-color-blue focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-4 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-color-blue dark:hover:bg-blue-800 focus:outline-none dark:focus:ring-blue-300">
                            Download
                        </a>
                        <button data-collapse-toggle="mobile-menu" type="button"
                            ...
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M3 5h14a1 1 0 110 2H3a1 1 0 110-2zM3 10h14a1 1 0 110 2H3a1 1 0 110-2zM3 15h14a1 1 0 110 2H3a1 1 0 110-2z" clip-rule="evenodd"></path>
                            </svg>
                        </button>
                    </div>
                    <div class="hidden items-center justify-between w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu">
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <a href="/"
                                    class="block py-2 pl-3 pr-4 text-purple-700 bg-purple-700 rounded lg:bg-transparent lg:text-purple-700 lg:p-0 dark:text-purple-400"
                                    aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href="/jobseeker"
                                    class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-blue-700 dark:hover:bg-blue-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Jobseeker</a>
                            </li>
                            <li>
                                <a href="/recruiter"
        ...
        <footer>
            <div class="mt-8 bg-color-blue pt-9">
                    ...
                    <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                        <div class="md:w-[316px]">
                            <p class="text-[18px] font-medium text-white">
                                <img src="/img/jobs2.png" alt="" class="h-18 w-16 ">
                            </p>
                            <p class="mt-[10px] text-[15px] font-normal text-white/[80%] "> At JobSeva, we are more than just a job portal; we are your dedicated partner on the path to professional success. Whether you're a seasoned professional seeking new challenges or a recent graduate embarking on your career journey, our comprehensive suite of services is designed to empower you at every step.</p>
                            <div class="mt-[18px] flex gap-4">
                            <a href="#" class="text-color-blob hover:text-white transition-colors duration-300"><i
                        ...
                        <div class="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
                            <div class="">
                                <p class="text-deutziawhite font-inter text-[18px] font-medium leading-normal">Jobseva</p>
                                <ul>
                                    <li class="mt-[15px]"><a
                                            class="text-deutziawhite  hover:underline-offset-4 font-inter text-[15px] font-medium "
                                            href="/">Home</a></li>
                                    <li class="mt-[15px]"><a
                                            class="text-deutziawhite hover:underline-offset-4 font-inter text-[15px] font-meduim "
                                    ...
                                    <li class="mt-[15px]"><a
                                            class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-medium"
                                            href="/privacy">Privcay policy</a></li>
                                </ul>
                            </div>
                            <div class="mt-6 flex flex-col gap-4 sm:mt-0">
                                ...
                                <div class="flex gap-4 sm:flex-col">
                                    <a target="_blank"
                                        href="#" target="_blank"><img alt="facebook icon" loading="lazy" width="168" height="50" decoding="async" data-nimg="1" style="color:transparent" src="/img/ps.png" />
...
<script>
    ...
    document.querySelector(".card__inner").addEventListener("click", function(e) {
