...
<section class="w-full flex justify-center flex-wrap sm:flex-row-reverse gap-3 p-4 md:mt-6">
        ...
        <div class="px-4 max-w-[640px]">
            ...
            <div class="flex flex-col items-center">
                ...
                <a href="https://www.youtube.com/watch?v=SPAr1TaSW2o">
                    <svg id="svg51" class="h-32 py-6" version="1.1" viewBox="0 0 180 53.333" xml:space="preserve"
                ...
                <div class="flex items-center gap-6 mt-4 pl-1">
                    <a class="text-gray-700 hover:text-orange transition-colors"
                        aria-label="Visit TrendyMinds Instagram" href="https://www.instagram.com/audiostoryappstudio" target="_blank"><svg
                    ...
                    <a class="text-gray-700 hover:text-orange transition-colors" aria-label="Visit TrendyMinds YouTube"
                        href="https://t.me/audiostoryappstudio" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                            class="h-8">
                            <path fill="currentColor"
                    ...
                    <a class="text-gray-700 hover:text-orange transition-colors" aria-label="Visit TrendyMinds YouTube"
                        href="https://www.youtube.com/@audiostoryappstudio" target="_blank">
        ...
        <div class="max-w-lg flex justify-center items-center">
            ...
            <img src="/img/about12.png" class="h-[600px]" alt="">
        </div>
